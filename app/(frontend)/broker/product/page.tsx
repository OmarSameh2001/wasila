...
export default function AdminProduct() {
  const products = [
    {
      ...
      icon: Heart,
      href: "/broker/product/individual_medical",
      gradient: "from-gray-400 dark:from-gray-900 to-blue-900"
    },
    {
      title: "SME Medical",
      icon: Briefcase,
      href: "/broker/product/sme",
      gradient: "from-gray-400 dark:from-gray-900 to-blue-900"
    },
    {
  ...
  return (
    <div className="flex flex-col min-h-[90vh] justify-center items-center bg-gray-200 dark:bg-black px-4 py-12">
      <h1 className="text-gray-900 dark:text-white text-3xl font-semibold mb-12">Your Own Products</h1>
