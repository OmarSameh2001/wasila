              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-800 p-8 rounded-xl shadow-sm hover:shadow-md transition">
                  ...
                  <p className="text-gray-600 dark:text-blue-100 leading-relaxed">
                    Get instant quote with multi products from multiple
                    providers in seconds. No more waiting days for comparisons.
                ...
                <div className="bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-800 p-8 rounded-xl shadow-sm hover:shadow-md transition">
                  ...
                  <p className="text-gray-600 dark:text-blue-100 leading-relaxed">
                    Designed with real broker workflows in mind. We understand
                    your challenges because we've been there. Every feature
                ...
                <div className="bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-800 p-8 rounded-xl shadow-sm hover:shadow-md transition">
                  ...
                  <p className="text-gray-600 dark:text-blue-100 leading-relaxed">
                    Create your own products or use website's offerings all in
                    one platform. Your complete insurance solution, simplified
                    and streamlined.
                  </p>
                </div>
              </div>
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-12">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-blue-100">
                    Select the best option for your client and complete the
                    process seamlessly through our platform.
                  </p>
                </div>
              </div>
            </div>
